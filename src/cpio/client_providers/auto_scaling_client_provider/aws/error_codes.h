...
#ifndef CPIO_CLIENT_PROVIDERS_AUTO_SCALING_CLIENT_PROVIDER_AWS_ERROR_CODES_H_
#define CPIO_CLIENT_PROVIDERS_AUTO_SCALING_CLIENT_PROVIDER_AWS_ERROR_CODES_H_
...
#endif  // CPIO_CLIENT_PROVIDERS_AUTO_SCALING_CLIENT_PROVIDER_AWS_ERROR_CODES_H_
