...
#define SNP_GET_REPORT \
  _IOWR(SNP_GUEST_REQ_IOC_TYPE, 0x0, snp_guest_request_ioctl)
#define SNP_GET_DERIVED_KEY \
  _IOWR(SNP_GUEST_REQ_IOC_TYPE, 0x1, snp_guest_request_ioctl)
#define SNP_GET_EXT_REPORT \
  _IOWR(SNP_GUEST_REQ_IOC_TYPE, 0x2, snp_guest_request_ioctl)
...
} snp_report_req;        // aka snp_report_req in (linux)
