...
#ifndef SRC_CPP_LOGGER_REQUEST_CONTEXT_LOGGER_TEST_H_
#define SRC_CPP_LOGGER_REQUEST_CONTEXT_LOGGER_TEST_H_
...
#endif  // SRC_CPP_LOGGER_REQUEST_CONTEXT_LOGGER_TEST_H_
