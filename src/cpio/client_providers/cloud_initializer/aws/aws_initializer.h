...
#ifndef CPIO_CLIENT_PROVIDERS_CLOUD_INITIALIZER_AWS_AWS_INITIALIZER_H_
#define CPIO_CLIENT_PROVIDERS_CLOUD_INITIALIZER_AWS_AWS_INITIALIZER_H_
...
#endif  // CPIO_CLIENT_PROVIDERS_CLOUD_INITIALIZER_AWS_AWS_INITIALIZER_H_
