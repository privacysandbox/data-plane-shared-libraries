...
#ifndef SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_H_
#define SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_H_
...
#include "src/cpp/logger/logger.pb.h"
...
#endif  // SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_H_
