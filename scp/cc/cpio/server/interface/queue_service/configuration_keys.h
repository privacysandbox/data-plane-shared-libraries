...
#ifndef CPIO_SERVER_INTERFACE_QUEUE_SERVICE_CONFIGURATION_KEYS_H_
#define CPIO_SERVER_INTERFACE_QUEUE_SERVICE_CONFIGURATION_KEYS_H_
...
#endif  // CPIO_SERVER_INTERFACE_QUEUE_SERVICE_CONFIGURATION_KEYS_H_
