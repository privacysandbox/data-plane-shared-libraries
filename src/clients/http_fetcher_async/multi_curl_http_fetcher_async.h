...
#ifndef SRC_CLIENTS_HTTP_FETCHER_ASYNC_MULTI_CURL_HTTP_FETCHER_ASYNC_H_
#define SRC_CLIENTS_HTTP_FETCHER_ASYNC_MULTI_CURL_HTTP_FETCHER_ASYNC_H_
...
#endif  // SRC_CLIENTS_HTTP_FETCHER_ASYNC_MULTI_CURL_HTTP_FETCHER_ASYNC_H_
