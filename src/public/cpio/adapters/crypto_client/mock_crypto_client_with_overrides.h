...
#ifndef PUBLIC_CPIO_ADAPTERS_CRYPTO_CLIENT_SRC_MOCK_CRYPTO_CLIENT_WITH_OVERRIDES_H_
#define PUBLIC_CPIO_ADAPTERS_CRYPTO_CLIENT_SRC_MOCK_CRYPTO_CLIENT_WITH_OVERRIDES_H_
...
#endif  // PUBLIC_CPIO_ADAPTERS_CRYPTO_CLIENT_SRC_MOCK_CRYPTO_CLIENT_WITH_OVERRIDES_H_
