...
#define PS_LOC                                                         \
  privacy_sandbox::server_common::SourceLocation::DoNotInvokeDirectly( \
      __LINE__, __FILE__)
#define PS_LOC_CURRENT_DEFAULT_ARG \
  = privacy_sandbox::server_common::SourceLocation::current()

#endif  // SERVICES_COMMON_UTIL_SOURCE_LOCATION_H_
