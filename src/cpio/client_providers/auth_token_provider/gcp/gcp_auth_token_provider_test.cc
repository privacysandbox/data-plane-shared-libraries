...
#include "src/cpio/client_providers/auth_token_provider/src/gcp/gcp_auth_token_provider.h"
...
#include "src/cpio/client_providers/auth_token_provider/src/gcp/error_codes.h"
