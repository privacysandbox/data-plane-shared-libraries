...
#ifndef CPIO_SERVER_SRC_AUTO_SCALING_SERVICE_TEST_AWS_TEST_CONFIGURATION_KEYS_H_
#define CPIO_SERVER_SRC_AUTO_SCALING_SERVICE_TEST_AWS_TEST_CONFIGURATION_KEYS_H_
...
#endif  // CPIO_SERVER_SRC_AUTO_SCALING_SERVICE_TEST_AWS_TEST_CONFIGURATION_KEYS_H_
