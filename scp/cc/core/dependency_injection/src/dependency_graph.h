...
#ifndef CORE_DEPENDENCY_INJECTION_SRC_DEPENDENCY_GRAPH_H_
#define CORE_DEPENDENCY_INJECTION_SRC_DEPENDENCY_GRAPH_H_
...
#endif  // CORE_DEPENDENCY_INJECTION_SRC_DEPENDENCY_GRAPH_H_
