 ...
 */
#ifndef SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_TEST_H_
#define SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_TEST_H_
...
#include "src/cpp/logger/request_context_logger_test.h"
...
#endif  // SRC_CPP_LOGGER_REQUEST_CONTEXT_IMPL_TEST_H_
