...
def scp_repositories():
    http_archive(
        ...
        sha256 = "d99fc6f45d3fc3ed5f3aef60a2562761573a564451902372364b84d1584baed2",
        strip_prefix = "control-plane-shared-libraries-0.85.0",
        patch_args = ["-p1"],
        patches = [Label("//third_party:shared_control_plane.patch")],
        urls = [
            "https://github.com/privacysandbox/control-plane-shared-libraries/archive/refs/tags/v0.85.0.zip",
        ],
    )
...
def cpp_dependencies():
    ...
    maybe(
        ...
        sha256 = "fdfa3fb83d39e9b8a117000f4e8bb04db774b25d77443b4cfb31fe1335bab998",
        strip_prefix = "opentelemetry-cpp-1.10.0",
        patch_args = ["-p1"],
        patches = [Label("//third_party:opentelemetry.patch")],
        urls = [
            "https://github.com/open-telemetry/opentelemetry-cpp/archive/refs/tags/v1.10.0.zip",
        ],
    )
    maybe(
        http_archive,
