...
#ifndef CORE_NOSQL_DATABASE_PROVIDER_SRC_GCP_GCP_SPANNER_H_
#define CORE_NOSQL_DATABASE_PROVIDER_SRC_GCP_GCP_SPANNER_H_
...
#endif  // CORE_NOSQL_DATABASE_PROVIDER_SRC_GCP_GCP_SPANNER_H_
