...
#ifndef CPIO_SERVER_SRC_QUEUE_SERVICE_AWS_AWS_QUEUE_SERVICE_FACTORY_H_
#define CPIO_SERVER_SRC_QUEUE_SERVICE_AWS_AWS_QUEUE_SERVICE_FACTORY_H_
...
#endif  // CPIO_SERVER_SRC_QUEUE_SERVICE_AWS_AWS_QUEUE_SERVICE_FACTORY_H_
