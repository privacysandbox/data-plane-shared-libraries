...
#ifndef CPIO_CLIENT_PROVIDERS_QUEUE_CLIENT_PROVIDER_AWS_SQS_ERROR_CONVERTER_H_
#define CPIO_CLIENT_PROVIDERS_QUEUE_CLIENT_PROVIDER_AWS_SQS_ERROR_CONVERTER_H_
...
#endif  // CPIO_CLIENT_PROVIDERS_QUEUE_CLIENT_PROVIDER_AWS_SQS_ERROR_CONVERTER_H_
