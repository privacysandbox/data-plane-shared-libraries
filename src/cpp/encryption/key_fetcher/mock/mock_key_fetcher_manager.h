...
#ifndef SRC_CPP_ENCRYPTION_KEY_FETCHER_MOCK_MOCK_KEY_FETCHER_MANAGER_H_
#define SRC_CPP_ENCRYPTION_KEY_FETCHER_MOCK_MOCK_KEY_FETCHER_MANAGER_H_
...
#endif  // SRC_CPP_ENCRYPTION_KEY_FETCHER_MOCK_MOCK_KEY_FETCHER_MANAGER_H_
