...
#ifndef CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_AZURE_AZURE_AUTH_TOKEN_PROVIDER_H_
#define CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_AZURE_AZURE_AUTH_TOKEN_PROVIDER_H_
 ...
 */
class AzureAuthTokenProvider : public AuthTokenProviderInterface {
 public:
  explicit AzureAuthTokenProvider(
...
#endif  // CPIO_CLIENT_PROVIDERS_AUTH_TOKEN_PROVIDER_AZURE_AZURE_AUTH_TOKEN_PROVIDER_H_
