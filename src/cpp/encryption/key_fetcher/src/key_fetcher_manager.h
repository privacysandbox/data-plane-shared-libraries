...
#ifndef SRC_CPP_ENCRYPTION_KEY_FETCHER_KEY_FETCHER_MANAGER_H_
#define SRC_CPP_ENCRYPTION_KEY_FETCHER_KEY_FETCHER_MANAGER_H_
...
class KeyFetcherManager : public KeyFetcherManagerInterface {
 public:
  ...
  absl::StatusOr<google::scp::cpio::PublicKey> GetPublicKey() noexcept override;
...
#endif  // SRC_CPP_ENCRYPTION_KEY_FETCHER_KEY_FETCHER_MANAGER_H_
