...
#ifndef CORE_INTERFACE_TOKEN_PROVIDER_CACHE_INTERFACE_H_
#define CORE_INTERFACE_TOKEN_PROVIDER_CACHE_INTERFACE_H_
...
#endif  // CORE_INTERFACE_TOKEN_PROVIDER_CACHE_INTERFACE_H_
