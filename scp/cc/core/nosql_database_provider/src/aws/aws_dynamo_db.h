...
#ifndef CORE_NOSQL_DATABASE_PROVIDER_SRC_AWS_AWS_DYNAMO_DB_H_
#define CORE_NOSQL_DATABASE_PROVIDER_SRC_AWS_AWS_DYNAMO_DB_H_
...
#endif  // CORE_NOSQL_DATABASE_PROVIDER_SRC_AWS_AWS_DYNAMO_DB_H_
