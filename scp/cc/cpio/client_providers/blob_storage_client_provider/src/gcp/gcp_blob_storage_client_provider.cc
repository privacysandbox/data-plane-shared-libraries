...
#include "scp/cc/core/interface/configuration_keys.h"
...
ExecutionResult GcpBlobStorageClientProvider::GetBlob(
  ...
  if (auto schedule_result = io_async_executor_->Schedule(
          [=, this] { GetBlobInternal(get_blob_context); },
...
ExecutionResult GcpBlobStorageClientProvider::ListBlobsMetadata(
  ...
  if (auto schedule_result = io_async_executor_->Schedule(
          [=, this] { ListBlobsMetadataInternal(list_blobs_context); },
          AsyncPriority::Normal);
      !schedule_result.Successful()) {
...
ExecutionResult GcpBlobStorageClientProvider::PutBlob(
  ...
  if (auto schedule_result = io_async_executor_->Schedule(
          [=, this] { PutBlobInternal(put_blob_context); },
          AsyncPriority::Normal);
      !schedule_result.Successful()) {
...
ExecutionResult GcpBlobStorageClientProvider::PutBlobStream(
  ...
  if (auto schedule_result = io_async_executor_->Schedule(
          [=, this] { InitPutBlobStream(put_blob_stream_context); },
          AsyncPriority::Normal);
      !schedule_result.Successful()) {
...
void GcpBlobStorageClientProvider::PutBlobStreamInternal(
  ...
  if (request == nullptr) {
    ...
    auto schedule_result = io_async_executor_->ScheduleFor(
        [=, this] { PutBlobStreamInternal(put_blob_stream_context, tracker); },
...
ExecutionResult GcpBlobStorageClientProvider::DeleteBlob(
  ...
  if (auto schedule_result = io_async_executor_->Schedule(
          [=, this] { DeleteBlobInternal(delete_blob_context); },
          AsyncPriority::Normal);
      !schedule_result.Successful()) {
