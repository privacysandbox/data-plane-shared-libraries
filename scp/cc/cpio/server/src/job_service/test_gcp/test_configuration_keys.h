...
static constexpr char kTestGcpJobClientProjectId[] =
    "cmrt_sdk_test_gcp_job_client_project_id";
// Optional. The impersonate SA to talk to cloud storage.
static constexpr char kTestGcpJobClientImpersonateServiceAccount[] =
    "cmrt_sdk_test_gcp_job_client_impersonate_service_account";
// Optional. The access token to authenticate the communication to cloud
// storage.
